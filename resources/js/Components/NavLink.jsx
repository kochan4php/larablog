...
const NavLink = ({ href, active, children }) => (
  <Link
    ...
    className={
      active
        ? "inline-flex items-center px-1 pt-1 border-b-2 border-slate-200 text-base font-medium leading-5 focus:outline-none focus:border-indigo-700 transition duration-150 ease-in-out"
